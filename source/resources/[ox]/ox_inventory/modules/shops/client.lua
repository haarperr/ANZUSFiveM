...
local function onEnterShop(point)
    ...
    local ret, ground, normal = GetGroundZAndNormalFor_3dCoord(point.coords.x, point.coords.y, point.coords.z)

		local entity = CreatePed(0, model, point.coords.x, point.coords.y, ret and ground or point.coords.z, point.heading, false, true)
		...
		if shared.target then
			...
			elseif shop.targets then
              ...
              zoneId = shopid,
						...
						shops[id].zoneId = exports.ox_target:addBoxZone({
