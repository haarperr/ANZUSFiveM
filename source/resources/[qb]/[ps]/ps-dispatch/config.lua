...
Config.DistanceWitnesses = 100 --distance required for the NPC to detect a crime and make a dispatch alert.
---------------------------------------------------------------
Config.Locale = 'en'
