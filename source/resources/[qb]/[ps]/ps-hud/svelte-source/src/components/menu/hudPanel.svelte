...
<div class="text-sm flex flex-col text-[#e8e8e8]">
  ...
  <div class="mx-4 mb-4 flex flex-col">
    ...
    />
    <Checkbox bind:checked={$MenuStore.isMarkChecked}
    primaryText={"Show Watermark"}
    secondaryText={"Disabling this will always keep your Watermark on your screen"}
    handleUpdateFunction={(checked) => fetchNui("showOutWatermark", {checked})}
  />
  </div>
