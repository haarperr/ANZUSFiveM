...
function GiveMoney(player, money)
    ...
    TriggerClientEvent('QBCore:Notify', player, 'You have won '..money..' chips', 'success')
    Player.Functions.AddItem("casinochips", money)
    TriggerClientEvent('inventory:client:ItemBox', player, QBCore.Shared.Items['casinochips'], 'add')
...
function TakeMoney(player, money)
    ...
    TriggerClientEvent('QBCore:Notify', player, 'You have bet '..money..' chips', 'success')
    Player.Functions.RemoveItem("casinochips", money)
    TriggerClientEvent('inventory:client:ItemBox', player, QBCore.Shared.Items['casinochips'], 'remove')
...
RegisterServerEvent("BLACKJACK:CheckPlayerBet", CheckPlayerBet)
