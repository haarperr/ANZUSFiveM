...
tables = { -- Spawns Ped Only -- Setup Currently For This https://forum.cfx.re/t/cayo-perico-casino-dlc-ipl-loader/2099391
    {
        coords = vector4(1036.81, 50.95, 68.06, 11.85), -- Done
        highStakes = false
    },
    {
        coords = vector4(1036.0, 55.00, 68.06, 187.18), -- Done
        highStakes = false
    },
    {
        coords = vector4(1043.47, 56.79, 68.06, 189.31), -- Done
        highStakes = false
    },
    {
        coords = vector4(1044.35, 52.69, 68.06, 10.42), -- Done
        highStakes = false
    },
    {
        coords = vector4(1033.75, 41.58, 68.87, 278.38), -- Done 
        highStakes = true
    },
    {
        coords = vector4(1027.95, 40.07, 68.86, 102.5), -- Done
        highStakes = true
    },
    {
        coords = vector4(1028.99, 62.20, 68.86, 281.39), -- Done
        highStakes = true
    },
    {
        coords = vector4(1022.97, 60.75, 68.86, 105.06), 
        highStakes = true
    },
}
...
customTables = { -- Spawns ped with table, example below
     -- {
    -- 	coords = vector4(1038.98, 57.77, 69.06, 342.24),
    -- 	highStakes = false,
    -- 	color = 0
    -- },
}
