...
Config.ItemNeededToGetAlias = 'vpn' -- What item do people need to be able to get an alias
...
Config.AnyOneMakeRace = false -- make this true if you want to allow any player to create a new race track
