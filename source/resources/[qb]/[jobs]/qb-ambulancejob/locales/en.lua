local Translations = {
  error = {
    ...
    no_defib = 'You need a Defibrillator',
  ...
  info = {
    ...
    stabilized = 'YOU ARE CURRENTLY STABILIZED',
    ...
    paletob_hospital = 'Paleto Hospital',
  ...
  mail = {
    ...
    message =
    'Dear %{gender} %{lastname}, <br /><br />Hereby you received an email with the costs of the last hospital visit.<br />The final costs have become: <strong>$%{costs}</strong><br /><br />We wish you a quick recovery!'
  },
  states = {
    irritated = 'irritated',
  ...
  text = {
    ...
    el_down = 'Take the elevator down',
