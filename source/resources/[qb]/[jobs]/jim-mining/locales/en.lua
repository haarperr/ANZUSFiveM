Loc.en = {
    ...
    info = {
        ...
        use_smelter = "Smelter",
        sell_ores = "Sell Ores",
        jewelcut = "Jewel Cutting Bench",
        jewelbuyer = "Talk To Jewel Buyer",
        crackingbench = "Cracking Bench",
        ...
        close = "Close",
        ['return'] = "Return",
        returncraft = "Return to crafting",
        rings = "Rings",
        necklaces = "Necklaces",
        earrings = "Earrings",
        smelter = "Smelter",
        ...
        smelter_bench = "Jewellery Crafting Bench",
        req_drill_bit = "Requires Drill Bit",
        gem_cut = "Gem Cutting",
        gem_cut_section = "Go to Gem Cutting Section",
        Gold_Menu = "Gold Smelting",
        Gold_Menu_section = "Go to Gold Smelting Section",
        Silver_Menu = "Silver Smelting",
        Silver_Menu_section = "Go to Silver Smelting Section",
        Iron_Menu = "Iron Smelting",
        Iron_Menu_section = "Go to Iron Smelting Section",
        Steel_Menu = "Steel Smelting",
        Steel_Menu_section = "Go to Steel Smelting Section",
        Misc_Menu = "Misc Item Smelting",
        Misc_Menu_section = "Go to Misc. Smelting Section",
