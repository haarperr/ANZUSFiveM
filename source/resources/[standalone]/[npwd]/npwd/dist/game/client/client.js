(() => {
  ...
  var exps, getCurrentGameTime, showPhone, hidePhone, checkHasPhone, eventCb;
  var init_cl_main = __esm({
    "client/cl_main.ts"() {
      ...
      showPhone = () => __async(void 0, null, function* () {
        ...
        let hasVPN = global.exports["ox_inventory"].GetSlotWithItem("vpn");
        hasVPN = ((_a = hasVPN == null ? void 0 : hasVPN.metadata) == null ? void 0 : _a.durability) > new Date().getTime() / 1e3;
        sendMessage("PHONE", "npwd:setVPN" /* HAS_VPN */, hasVPN);
      ...
      eventCb = null;
      RegisterNuiCB("npwd:getPremiumStatus" /* GET_PREMIUM_STATUS */, (_, cb) => {
        eventCb = cb;
        emitNet("npwd:getPremiumStatus" /* GET_PREMIUM_STATUS */, {});
      });
      onNet("npwd:getPremiumStatus" /* GET_PREMIUM_STATUS */, (data) => {
        if (eventCb)
          eventCb(data);
      });
      if (config.PhoneAsItem.enabled) {
  ...
  var require_cl_exports = __commonJS({
    "client/cl_exports.ts"(exports) {
      ...
      exps2("GetCitizenID", (id) => __async(exports, null, function* () {
        global.clientCitizenID = id;
        sendMessage("AGDETAIL", "npwd:SetCitizenID" /* SET_CITIZEN_ID */, id);
      }));
      exps2("SetLicences", (licenses) => __async(exports, null, function* () {
        sendMessage("AGDETAIL", "npwd:SetLicences" /* SET_LICENCES */, licenses);
      }));
      exps2("openApp", (app) => {
