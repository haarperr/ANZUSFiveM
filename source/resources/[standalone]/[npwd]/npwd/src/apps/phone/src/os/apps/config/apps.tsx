...
import { AGDetailApp } from '@apps/agdetail/components/AGDetailApp';
...
export const APPS: IAppConfig[] = [
  ...
  {
    id: 'AGDETAIL',
    nameLocale: 'APPS_AGDETAIL',
    backgroundColor: grey['A400'],
    color: common.white,
    path: '/agdetail',
    Route: () => (
      <AppRoute id="AGDETAIL" path="/agdetail" component={AGDetailApp} emitOnOpen={false} />
    ),
  },
];
