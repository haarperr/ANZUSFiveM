...
Config.ClothingRooms = {
  ...
  {
    job = "ambulance",   -- paleto medical
    coords = vector4(454.91, -990.89, 30.69, 193.4),
    size = vector3(4, 4, 4),
    rotation = 45,
    usePoly = true,
    points = {
      vec3(-265.92001342773, 6314.4599609375, 32.95),
      vec3(-271.5, 6320.009765625, 32.95),
      vec3(-266.51998901367, 6324.8100585938, 32.95),
      vec3(-261.10998535156, 6319.3598632812, 32.95),
    }
  },
  {
    job = "ambulance",   -- pillbox medical
    coords = vector4(454.91, -990.89, 30.69, 193.4),
    size = vector3(4, 4, 4),
    rotation = 45,
    usePoly = true,
    points = {
      vec3(301.89001464844, -601.01000976562, 43.0),
		  vec3(299.98999023438, -600.35998535156, 43.0),
		  vec3(301.08999633789, -597.13000488281, 43.0),
		  vec3(303.23001098633, -597.91998291016, 43.0),
    }
  },
