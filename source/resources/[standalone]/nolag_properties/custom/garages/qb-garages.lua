...
Config.Functions["OpenGarageMenu"] = {
    ...
    onExit = function(property)
        TriggerEvent('qb-garages:client:setHouseGarage', property.id, false)
    end,
    onEnter = function(property)
        ...
        TriggerEvent('qb-garages:client:setHouseGarage', property.id, property:hasKey())
    end,
    onCreate = function (property, point)
        TriggerEvent("qb-garages:client:addHouseGarage", property.id, {
            takeVehicle = {
                x = point.x,
                y = point.y,
                z = point.z
